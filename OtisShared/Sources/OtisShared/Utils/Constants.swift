...
public enum Constants {
    ...
    public static let loggerSubsystem = "nl.jaapstronks.Otis"

    /// Watch logger subsystem identifier
    public static let watchLoggerSubsystem = "nl.jaapstronks.Otis.watchkitapp"

    /// App group identifier for shared data
    public static let appGroupIdentifier = "group.jaapstronks.Otis"

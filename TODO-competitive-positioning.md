...
| Slaapanalyse | ❌ | ❌ | ✅ gratis |
| Basis trainingstips | Premium | Premium | ✅ gratis |
| Socialisatie-checklist | ❌ | Premium | ✅ gratis |
| Partner sharing (2p) | Premium | ❌ | ✅ gratis (CloudKit) |
| Timeline/dagverloop | ❌ | ❌ | ✅ gratis |
| Patroonherkenning | Premium | ❌ | ✅ gratis |

## Release Roadmap

### v1.0 — App Store Launch
- Alles wat er nu is + V2 features (TODO-v2.md)
- CloudKit sync + partner sharing (TODO-cloudkit-sync.md)
- Basis training library, 12 commando's (TODO-training-library.md)
- Socialisatie-checklist (TODO-socialisatie-checklist.md)
- Clicker tool (TODO-clicker.md)

### v1.1 — Data Intelligence
- Smart potty reminders (TODO-smart-reminders.md)
- Training log in timeline
- Push notifications (opt-in, nuttig)
- Export/share (PDF voor dierenarts)
...
- Week-in-review samenvattingen
- Apple Watch complicatie (snelle log)

### NOOIT bouwen
- Video content productie (te duur, te veel concurrentie)

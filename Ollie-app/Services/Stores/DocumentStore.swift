...
//  Otis-app
//
//  Manages documents with Core Data and CKSyncEngine-based CloudKit sync
//  Documents are stored per-profile and sync via SyncCoordinator
...
final class DocumentStore: BaseStore, ProfileAccessible {
    ...
    override var cloudKitRecordType: String? { "CD_CDDocument" }
    ...
    func addDocument(_ document: Document, image: UIImage? = nil) -> Bool {
        ...
        return performSave(operation: "Added document: \(document.displayTitle)", entityId: document.id) {
            performInitialLoad()
        }
    }
    ...
    func addDocument(_ document: Document, pdfData: Data?) -> Bool {
        ...
        return performSave(operation: "Added PDF document: \(document.displayTitle)", entityId: document.id) {
            performInitialLoad()
        }
    }
    ...
    func updateDocument(_ document: Document, image: UIImage? = nil, removeAttachment: Bool = false) -> Bool {
        ...
        return performSave(operation: "Updated document: \(document.displayTitle)", entityId: document.id) {
            performInitialLoad()
        }
    }
    ...
    func updateDocument(_ document: Document, pdfData: Data?) -> Bool {
        ...
        return performSave(operation: "Updated document with PDF: \(document.displayTitle)", entityId: document.id) {
            performInitialLoad()
        }
    }
    ...
    func deleteDocument(_ document: Document) -> Bool {
        ...
        return performDelete(operation: "Deleted document: \(document.displayTitle)", entityId: document.id) {

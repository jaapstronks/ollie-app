...
//  Otis-app
//
//  CRUD operations and persistence for WalkSpot with Core Data and CKSyncEngine-based CloudKit sync
//
...
/// Manages saved walk spots with Core Data and CKSyncEngine-based CloudKit sync
@MainActor

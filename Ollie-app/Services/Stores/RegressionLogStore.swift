...
final class RegressionLogStore: BaseStore {
    ...
    override var cloudKitRecordType: String? { "CD_CDRegressionLog" }
    ...
    func logRegression(
        ...
        performSave(operation: "Log regression for skill: \(skillId)", entityId: entry.id) {
    ...
    func markRecovered(
        ...
        performSave(operation: "Mark regression recovered: \(regressionId)", entityId: regressionId) {
    ...
    func deleteRegression(id: UUID) {
        ...
        performDelete(operation: "Delete regression log: \(id)", entityId: id) {

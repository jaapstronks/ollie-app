...
//  Otis-app
//
//  Manages appointments with Core Data and CKSyncEngine-based CloudKit sync
//  Appointments are stored per-profile and sync via SyncCoordinator
...
final class AppointmentStore: BaseStore, ProfileAccessible {
    ...
    override var cloudKitRecordType: String? { "CD_CDDogAppointment" }
    ...
    func addAppointment(_ appointment: DogAppointment) -> Bool {
        ...
        return performSave(operation: "Added appointment: \(appointment.title)", entityId: appointment.id) {
            performInitialLoad()
        }
    }
    ...
    func updateAppointment(_ appointment: DogAppointment) -> Bool {
        ...
        return performSave(operation: "Updated appointment: \(appointment.title)", entityId: appointment.id) {
            performInitialLoad()
        }
    }
    ...
    func deleteAppointment(_ appointment: DogAppointment) -> Bool {
        ...
        return performDelete(operation: "Deleted appointment: \(appointment.title)", entityId: appointment.id) {

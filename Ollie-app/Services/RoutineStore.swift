...
//  and enrichment activities for adult dogs with Core Data and automatic CloudKit sync.
//
...
final class RoutineStore: BaseStore, ProfileAccessible {
    ...
    func addRoutineItem(_ item: RoutineItem) -> Bool {
        ...
        return performSave(operation: "Added routine item: \(item.label)") {
    ...
    func updateRoutineItem(_ item: RoutineItem) -> Bool {
        ...
        return performSave(operation: "Updated routine item: \(item.label)") {
    ...
    func addWeightGoal(_ goal: WeightGoal) -> Bool {
        ...
        return performSave(operation: "Added weight goal: \(String(format: "%.1f", goal.targetWeightKg)) kg") {
            performInitialLoad()
        }
    }
    ...
    func updateWeightGoal(_ goal: WeightGoal) -> Bool {
        ...
        return performSave(operation: "Updated weight goal") {
            performInitialLoad()
        }
    }
    ...
    func addBodyConditionScore(_ score: BodyConditionScore) -> Bool {
        ...
        return performSave(operation: "Added BCS: \(score.score)/9") {
    ...
    func addGroomingActivity(_ activity: GroomingActivity) -> Bool {
        ...
        return performSave(operation: "Added grooming: \(activity.type.label)") {
    ...
    func updateGroomingActivity(_ activity: GroomingActivity) -> Bool {
        ...
        return performSave(operation: "Updated grooming: \(activity.type.label)") {
    ...
    func addEnrichmentActivity(_ activity: EnrichmentActivity) -> Bool {
        ...
        return performSave(operation: "Added enrichment: \(activity.type.label)") {

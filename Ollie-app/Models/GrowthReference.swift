...
struct GrowthReference: Identifiable {
    let id = UUID()
    let weeks: Int
    let kg: Double
    let label: String
...
enum GrowthCurves {
    ...
    /// Source: Standard veterinary growth charts
    ...
    static func curve(for size: PuppyProfile.SizeCategory) -> [GrowthReference] {
        // Currently only Golden Retriever (large) is implemented
        // Add more curves as needed for other sizes
        switch size {
        case .small:
    ...
    static let smallDogCurve: [GrowthReference] = [
    ...
    static let mediumDogCurve: [GrowthReference] = [
    ...
    static let extraLargeDogCurve: [GrowthReference] = [
    ...
    static let tolerancePercent: Double = 0.15
}
